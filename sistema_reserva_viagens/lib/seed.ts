    ...
    data: [
      {
       ...
       descricao:
        ...
        dataInicio: new Date("2023-07-03"),
        dataFim: new Date("2023-07-30"),
        localizacao: "Amalfi, Itália",
        countryCode: "IT",
        fotoCapa:
        ...
        precoPorDia: 250,
       destaques: ["Café da manhã incluso", "Piscina", "Wifi grátis", "Estacionamento grátis", "Vista paradisíaca", "Luxuoso"],
        recommended: true,
        maximoHospedes: 5,
      },
      {
       ...
       descricao:
        ...
        dataInicio: new Date("2023-07-03"),
        dataFim: new Date("2023-07-30"),
        localizacao: "New York, Estados Unidos",
        countryCode: "US",
        fotoCapa:
